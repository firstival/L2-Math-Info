...
static inline int est_vivante(int i, int j, grille g){return g.cellules[i][j] > 0;} // TODO : à modifier
// la cellule continue à vivre : sans viellissement
void set_ne_viellit_pas(int i, int j, grille g); // TODO : à ajouter
// la cellule continue à vivre : avec viellissement
void set_viellit(int i, int j, grille g); // TODO : à ajouter
