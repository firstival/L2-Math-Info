...
static inline int est_viable(int i, int j, grille g){return g.cellules[i][j] >= 0;} // TODO : à ajouter
...
static inline void set_nonviable(int i, int j, grille g){g.cellules[i][j] = -1;} // TODO : à ajouter
